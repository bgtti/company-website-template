 ...
 * @param {string} data.occupation // Honeypot field, should be empty for valid submissions
...
export function sendMessage(data = {}) {
 ...
 const occupation = data.occupation ?? ""; // Honeypot field, should be empty for valid submissions
 ...
 if (occupation.trim() !== "") {
  // Honeypot triggered, silently reject the submission but return success response to avoid tipping off bots
 ...
 let requestData = {
  ...
  "subject": subject,
  "message": message,
  "occupation": occupation, //Honeypot
 }
